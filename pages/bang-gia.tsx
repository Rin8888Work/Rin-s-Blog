						...
						<div className={`p-0 ${index == 1 ? '' : 'py-10 sm:py-12'}`} key={index}>
							...
							>
								<div className=" p-6 text-center">
									...
									>
										<a
											className="inline-block w-1/2 rounded bg-teal-700 bg-transparent px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white transition duration-150 ease-in-out hover:bg-teal-900 focus:outline-none focus:ring-0 "
											target={`_blank`}
											href={`/go/${seedingLink.adviseLink.key}`}
										>
											Nhận tư vấn
								...
								<div className="p-6">
									<h4 className=" pb-2 font-bold">Tích hợp</h4>
