...
export default function Contact() {
	return (
		<ContactLayout>
			...
			<div className="mb-5 mt-14  sm:mx-auto sm:w-3/4">
							...
							<div className="flex flex-wrap">
								<div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 lg:w-6/12 lg:px-6">
									...
									<p className="mt-3 text-gray-500">
										Gọi cho chúng tôi để nói chuyện với một thành viên trong
										nhóm của chúng tôi. Chúng tôi luôn sẵn lòng giúp đỡ.
									</p>
								</div>
								<div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 lg:w-6/12 lg:px-6">
									<div className="flex items-start">
										...
										<div className="ml-6 grow">
											<p className="mb-1 font-bold">Địa chỉ email</p>
											<p>
												<a
									...
									<p className="mt-3 text-gray-500">
										Gửi email cho mình nếu có thắc mắc chung, bao gồm các cơ hội
										tiếp thị và hợp tác.
									</p>
								</div>
								<div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 lg:w-6/12 lg:px-6">
									...
									<p className="mt-3 text-gray-500">
										Liên hệ LinkedIn của mình nếu có thắc mắc chung, bao gồm các
										cơ hội tiếp thị và hợp tác.
									</p>
								</div>
								<div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 lg:w-6/12 lg:px-6">
									<div className="align-start flex">
										...
										<div className="ml-6 grow">
											<p className="mb-1 font-bold">Tin nhắn Facebook</p>
											<p>
												<a
													target="_blank"
									...
									<p className="mt-3 text-gray-500">
										Liên hệ Facebook của mình nếu có thắc mắc chung, bao gồm các
										cơ hội tiếp thị và hợp tác.
									</p>
								</div>
							</div>
