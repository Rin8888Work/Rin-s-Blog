...
export function ProfileCard({ direction }: { direction?: 'column' | 'row' }) {
	let ref = useRef(null);
	...
	return (
		...
		>
			<div
				style={style}
				className={`relative overflow-hidden rounded-lg bg-white shadow-lg shadow-cyan-100/50 transition-all duration-200 ease-out dark:bg-dark dark:shadow-cyan-700/50 ${
					direction === 'column' ? '' : 'sm:flex'
				}`}
			>
				...
				{/* <SpotifyNowPlaying /> */}
				<ProfileCardInfo direction="column" />
